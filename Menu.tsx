      ...
      <div class="col-md-12">
        ...
        <div class="col-sm-4">
          <div class="card">
            ...
            <div class="block">
              <h3 class="header_block menu_open">{this.l(value)}</h3>
              <div class="paddinginside block_inside">
                <label class="col-md-4">{this.l('Select Icon')}</label>
                <div class="col-md-8">
                  <button
                ...
                <div class="col-md-8">
                  <select class="form-control {class2}" data-icons="">
                    <option
                      ...
                      value={
                        "<#if (key?contains('product') || key?contains('brand'))>/cat/<#else>/categories/</#if>{value2.Cpufull()}"
                      }
                    >
                      {'{value.title}'}
                    </option>
