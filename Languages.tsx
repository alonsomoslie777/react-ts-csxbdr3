  ...
  render() {
    ...
    <div class="card">
        ...
        <div class="add_new_top">  
                 ...
                 <#list view.listLang() as lang>
                       <div>
                          <p>
                              ...
                              <#if (lang?index == 0)><span class="fa fa-home"></span>{this.l('Default')} </span></#if>
                              <#if (lang?index > 0)><a href="#" >{this.l('Make default')}</a></#if>
                          </p>
                       </div>
                 </#list>
                </div>
                <div class="col-md-2"><br />
                   <button type="submit" class="btn btn_small"  > {this.l('Add language')}</button>
                </div>
            ...
            <div class="col-md-2"><br />
              <button type="submit" class="btn btn_small" > {this.l('Change')}</button>
           </div>
